		...
		<tr>
			<td>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right"><?= $this->lang->line('total'); ?></td>
					...
					<?php if(change_return_status()) {
						...
						<tr>
							<td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right"><?= $this->lang->line('refund'); ?></td>
					...
					<?php } ?>
					<tr>
						<td style=" padding-left: 2px; padding-right: 2px;" colspan="5" align="right"><?= $this->lang->line('due_amount'); ?></td>
