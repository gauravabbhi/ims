        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url();?>uploads/csv/examples/import-items-example.csv"><button type="button" class="btn btn-info pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
              ...
              <table class="table table-bordered table-hover " id="report-data" >
                ...
                <tbody id="tbodyid">
                  ...
                  <tr>
                    ...
                    <td style="color:green;"><?= $this->lang->line('required'); ?></td>
                  ...
                  <tr>
                    ...
                    <td style="font-style: italic;">(<?= $this->lang->line('optional'); ?>)</td>
                  ...
                  <tr>
                    <td><?=$i++;?></td>
                    <td><?= $this->lang->line('purchase_price'); ?></td>
                    <td style="color:green;"><?= $this->lang->line('required'); ?></td>
