 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api.column( 4 ).footer() ).html(app_number_format(invoice_total));
            $( api.column( 5 ).footer() ).html(app_number_format(sales_due));
            $( api.column( 6 ).footer() ).html(app_number_format(sales_return_due));
        },
        /*End Footer Total*/
    });
