                                       ...
                                       <div class="box-body">
                                          <div class="row">
                                             <div class="col-md-5">
                                               ...
                                               ?>
                                                <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label"><?= $this->lang->line('enable_round_off'); ?><label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                 ...
                                 <div class="col-md-12">
                                       <div class="box-body">
                                          <div class="row">
                                             ...
                                             <div class="col-md-8">
                                                <div class="form-group">
                                                   <label for="show_upi_code" class="col-sm-4 control-label"><?= $this->lang->line('show_upi_code_on_invoice'); ?></label>
                                                   <div class="col-sm-4">
