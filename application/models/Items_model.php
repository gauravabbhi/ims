...
class Items_model extends CI_Model {
	...
	var $column_order = array( 'a.id','a.item_image','a.item_code','a.item_name','b.category_name','a.lot_number','c.unit_name','a.stock','a.alert_qty','a.sales_price','d.tax_name','d.tax','a.status','e.brand_name','a.tax_type'); //set column field database for datatable orderable
	var $column_search = array( 'a.id','a.item_image','a.item_code','a.item_name','b.category_name','a.lot_number','c.unit_name','a.stock','a.alert_qty','a.sales_price','d.tax_name','d.tax','a.status','e.brand_name','a.custom_barcode','a.tax_type'); //set column field database for datatable searchable 
